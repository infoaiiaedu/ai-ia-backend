...
class DiagnosticSession(models.Model):
    ...
    current_level = models.PositiveSmallIntegerField(default=2)
    ...
    boundary_topic_id = models.IntegerField(null=True, blank=True)
    total_answered = models.PositiveSmallIntegerField(default=0)
    max_questions = models.PositiveSmallIntegerField(default=22)
    max_minutes = models.PositiveSmallIntegerField(default=12)
