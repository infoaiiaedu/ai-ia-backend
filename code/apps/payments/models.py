...
class Order(models.Model):
    ...
    external_id = models.CharField(
        max_length=100, unique=True, default="DUMMY_EXTERNAL_ID", verbose_name="გარე ID"
    )
    bog_id = models.CharField(
        max_length=100, default="DUMMY_BOG_ID", verbose_name="BOG ID"
    )
    parent_order_id = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="მშობელი შეკვეთის ID"
    )
...
class Subscription(models.Model):
    ...
    subject = models.ForeignKey(
        "core.Subject", on_delete=models.CASCADE, verbose_name="საგანი"
    )
